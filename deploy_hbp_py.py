...
fasting blood sugar=st.number_input("Blood sugar",min_value=0,max_value=1000,value=0)
...
Urine protein=st.number_input("urine protein",min_value=0,max_value=1000,value=0)
serum creatinine=st.number_input("serum creatinine",min_value=0,max_value=1000,value=0)
...
dental caries=st.number_input("dental caries",min_value=0,max_value=1000,value=0)
