...
waist=st.number_input("waist size",min_value=0.0,step=0.01)
eyesight=st.number_input("Eyesight(left)",min_value=0.0,step=0.01)
eyesight=st.number_input("Eyesight(right)",min_value=0.0,step=0.01)
...
hemoglobin=st.number_input("Hemoglobin",min_value=0.0,step=0.01)
Urine_protein=st.number_input("urine protein",min_value=0,max_value=1000,value=0)
serum_creatinine=st.number_input("serum creatinine",min_value=0.0,step=0.01)
